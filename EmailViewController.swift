...
class EmailViewController: UIViewController, ABPeoplePickerNavigationControllerDelegate, MFMailComposeViewControllerDelegate, UITextFieldDelegate, UIPickerViewDelegate, CNContactPickerDelegate {
    ...
    func contactUs(){
        ...
        let alert = UIAlertController(title: "Contact", message: "Email or rate us.", preferredStyle: UIAlertController.Style.alert)
    ...
    func sendEmail() {
        ...
        let toRecipents = ["yiziweizhu4104nf@163.com"]
        print(toRecipents)
    ...
    func rateUs() {
        ...
        if let url = URL(string: "itms-apps://itunes.apple.com/app/id1498622446") {
