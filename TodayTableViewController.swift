...
class TodayTableViewController: UITableViewController {
    ...
    func noInternetConnection() {
        ...
        if Reachability.isConnectedToNetwork() == true {
            ...
            let alert = UIAlertController(title: "Sorry, no internet connection found.", message: "ReminderMess requires an internet connection.", preferredStyle: UIAlertController.Style.alert)
